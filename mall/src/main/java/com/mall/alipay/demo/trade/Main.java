package com.mall.alipay.demo.trade;
...
public class Main {
    ...
    public void test_monitor_schedule_logic() {
        // 启动交易保障线程
        com.mall.alipay.demo.trade.DemoHbRunner demoRunner = new com.mall.alipay.demo.trade.DemoHbRunner (monitorService);
    ...
    public void test_trade_precreate() {
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
            ...
            .setTimeoutExpress(timeoutExpress)
                            .setNotifyUrl("http://webmall.natapp1.cc/order/alipay_callback.do")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
